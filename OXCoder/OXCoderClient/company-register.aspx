 <%@ Page Language="C#" AutoEventWireup="true" CodeBehind="company-register.aspx.cs" Inherits="OXCoderClient.hr_to_new_info" %>
			...
			<div class="col-md-6 col-md-push-3 col-xs-10 col-xs-push-1 col-sm-8 col-sm-push-2">
				<div id="content">
					<div class="row">
						<!-- 错误信息 -->
						<font color="red"></font>
						<form id="defaultForm" method="post" class="form-vertical bv-form" action="./company-register.aspx" enctype="multipart/form-data" novalidate="novalidate"><button type="submit" class="bv-hidden-submit" style="display: none; width: 0px; height: 0px;"></button>
